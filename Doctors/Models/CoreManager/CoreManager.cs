...
namespace Doctors.Models.CoreManager
{
    public class CoreManager
    {
        ...
        {
            Usr SU = db.Usrs.Where(o => o.UserName.ToLower().Equals(loginName))?.FirstOrDefault();
            if (SU != null)
            {
        ...
        {
            return db.Usrs.Where(o => o.UserName.Equals(loginName)
                                     && o.IsActive == true
                                     && o.ValidFrom <= System.DateTime.Now).Any();
        }
        public bool IsLoginName(string loginName, int id)
        {
            return db.Usrs.Where(o => o.UserName.Equals(loginName) && o.UserID != id
                                     && o.IsActive == true
                                     && o.ValidFrom <= System.DateTime.Now).Any();
        }
        public string GUP(string lname)
        {
            var user = db.Usrs.Where(o => o.UserName.ToLower().Equals(lname)
                                          && o.IsActive == true
