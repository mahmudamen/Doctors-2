...
namespace Doctors.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult AddUser()
        {
            ...
            ViewBag.emp = new SelectList(am.vUsrEmps, "ID", "FullName");
            return View();
        }
        [AuthorizeRoles("Admin")]
        [HttpPost]
        ...
        public ActionResult EditUser(int id)
        {
            ...
            //}
            Usr dpt = am.Usrs.Where(v => v.UserID == id).FirstOrDefault();
            var empi = am.EmpInfoes.Where(x => x.Usr == dpt.UserName).Select(c => c.FullName).FirstOrDefault();
            ViewBag.emp = empi;
            if (dpt == null)
            {
                return HttpNotFound();
